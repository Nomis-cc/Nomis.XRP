...
namespace Nomis.Xrpscan.Calculators
{
        ...
        IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
    {
        ...
        public RippleWalletStats GetStats()
        {
            ...
            var intervals = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
            ...
            var soldSum = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
                .GetTokensSum(
                    soldTokens
                        .Select(x => x.Hash!),
                    _transactions
            ...
            var buySum = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
                .GetTokensSum(
                    buyTokens
                        .Select(x => x.Hash!),
                    _transactions
            ...
            var buyNotSoldSum = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
                .GetTokensSum(
                    buyNotSoldTokens
                        .Select(x => x.Hash!),
                    _transactions
            ...
            var turnoverIntervals = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
            ...
            return new()
            {
                ...
                WalletAge = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>
                ...
                BalanceChangeInLastMonth = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>.GetBalanceChangeInLastMonth(turnoverIntervals),
                BalanceChangeInLastYear = IStatCalculator<RippleWalletStats, RippleTransactionIntervalData>.GetBalanceChangeInLastYear(turnoverIntervals),
