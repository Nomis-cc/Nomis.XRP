// ------------------------------------------------------------------------------------------------------
// <copyright file="RippleScoreCalculator.cs" company="Nomis">
...
{
    /// <summary>
    /// Ripple wallet score calculator.
    /// </summary>
    internal static class RippleScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<RippleTransactionIntervalData> stats)
        {
            if (stats.NoData)
            {
                return 0;
