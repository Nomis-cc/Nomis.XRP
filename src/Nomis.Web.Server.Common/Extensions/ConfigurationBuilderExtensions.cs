    ...
    public static class ConfigurationBuilderExtensions
    {
        ...
        public static IConfigurationBuilder AddJsonConfigs(this IConfigurationBuilder manager)
        {
            ...
            return manager
                ...
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(XrpscanSettings).ToLower()}.json"), false, true)
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(XrpscanSettings).ToLower()}.{env}.json"), true,
                    true);
        }
    }
}